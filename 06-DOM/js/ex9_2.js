...
let btnConferir = document.getElementById('btConferir')
...
function conferirSoma() {
    ...
    for (let index = 0; index < moedas.length; index++) {
        if (moedas[index].className == 'moeda1_00') {
            totalMoedas += 1
        } else if (moedas[index].className == 'moeda0_50') {
            totalMoedas += 0.50
        } else if (moedas[index].className == 'moeda0_25') {
            totalMoedas += 0.25
        } else {
            totalMoedas += 0.10
        }
